...
class MainMenu:
    ...
    def create_menu(self):
        ...
        self.menu.add.button(title="Tableau des pointages", font_size=GameConfig.MENU_FONT_P_SIZE,
                             font_color=GameConfig.FONT_COLOR,
        ...
        self.menu.add.button(title="Quitter", font_size=GameConfig.MENU_FONT_P_SIZE, font_color=GameConfig.FONT_COLOR,
                             font_name=pygame_menu.font.FONT_8BIT, action=lambda: pygame.quit(), background_color=None,
                             border_width=0)
